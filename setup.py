...
version = __import__('django_signed').__version__

setup(
    name='django-signed',
    version=version,
    description='Signed Cookies for Django',
    long_description="""django-signed implements a signing api 
    for django. See the README for more details.
    """,
    author='Simon Willison',
    author_email='easel.org/simonw',
    maintainer='Erik LaBianca',
    maintainer_email='erik.labianca@gmail.com',
    url='http://github.com/easel/django-signed',
